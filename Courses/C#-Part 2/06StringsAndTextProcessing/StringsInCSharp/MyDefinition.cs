...
class MyDefinition
{
    ...
    static void Main()
    {
      /*  1) Describe the strings in C#:
         * Strings are immutable sequences of characters (instances of the System.String Class in .NET Framework)
         * Declared by the keyword string in C#. Can be initialized by string literals
